...
(function($PS) {
  ...
  var showPlanet = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 18, column 1 - line 21, column 27): " + [ v.constructor.name ]);
  });
  var renderNextButton = function (action) {
      return Halogen_HTML_Elements.button((function () {
          ...
          throw new Error("Failed pattern match at Main (line 92, column 5 - line 94, column 62): " + [ action.constructor.name ]);
  ...
  var handleAction = function (v) {
      ...
      if (v instanceof SetPlanet) {
          ...
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $21.stage = new AskPlanet(updated);
              return $21;
          });
      };
      if (v instanceof GotoPlanetStage) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $26.stage = new AskPlanet(v.value0);
              return $26;
          });
      };
      if (v instanceof GotoGreetStage) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $30.stage = new Greet(v.value0);
              return $30;
          });
      };
      throw new Error("Failed pattern match at Main (line 62, column 1 - line 62, column 75): " + [ v.constructor.name ]);
  };
  ...
  var renderStage = function (v) {
      if (v instanceof AskName) {
          ...
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What is your name?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput((function () {
              var $41 = UpdateName.create(v.value0);
              return function ($42) {
                  return Data_Maybe.Just.create($41($42));
              };
          })()) ]), renderNextButton(Data_Functor.map(Data_Maybe.functorMaybe)(makeNextStage)(v.value0.name)) ]);
      };
      if (v instanceof AskPlanet) {
          var makeNextStage = function (name) {
          ...
          var makeButton = function (planet) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.checked(Data_Eq.eq(Data_Maybe.eqMaybe(eqPlanet))(v.value0.planet)(new Data_Maybe.Just(planet))), Halogen_HTML_Events.onChecked(Data_Function["const"](Data_Maybe.Just.create(new SetPlanet(v.value0, planet)))) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(Data_Show.show(showPlanet)(planet)) ]) ]);
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("So " + (v.value0.name + ", what planet do you hail from?")) ]), makeButton(Mars.value), makeButton(Neptune.value), makeButton(Uranus.value), renderNextButton(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(makeNextStage)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v.value0.name)))(v.value0.planet)) ]);
      };
      if (v instanceof Greet) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Greetings " + (v.value0.name + (" from " + (function () {
              if (v.value0.planet instanceof Mars) {
                  return "Mars";
              };
              if (v.value0.planet instanceof Neptune) {
                  return "Neptune";
              };
              if (v.value0.planet instanceof Uranus) {
                  return "Uranus";
              };
              throw new Error("Failed pattern match at Main (line 132, column 23 - line 135, column 43): " + [ v.value0.planet.constructor.name ]);
          })()))) ]);
      };
      throw new Error("Failed pattern match at Main (line 98, column 1 - line 98, column 62): " + [ v.constructor.name ]);
  };
  var render = function (state) {
      return renderStage(state.stage);
  };
